  ...
  return (
    <div className="grid gap-4">
      ...
      <label className="block">
        <span className={labelClass}>
          Details{" "}
          <span className="font-normal text-ink-400">(shown when expanded)</span>
        </span>
        <textarea
          name="detail"
          rows={4}
  ...
  return (
    <div>
      ...
      <p className="mt-4 max-w-2xl text-ink-500">
        Edit a card and press Save, reorder with the arrows, or add a new one at
        the bottom. Changes appear on the live site within a few seconds.
      </p>
