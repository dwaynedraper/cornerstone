  ...
  categories: [
    {
      ...
      featured: [
        {
          name: 'Brookhaven Subdivision',
          href: '#',
          imageSrc: 'https://plus.unsplash.com/premium_photo-1680185462024-449a2abaec28?q=80&w=2532&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
          imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
        },
        {
          name: 'Devonshire',
          href: '#',
          imageSrc: 'https://irp.cdn-website.com/5074329a/dms3rep/multi/DJI_0447XXXZa-3f12974d-28b06336.jpg?w=1000',
          imageAlt: 'Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.',
        },
        {
          name: 'Nowhereville High School',
          href: '#',
          imageSrc: 'https://media.istockphoto.com/id/184648037/photo/tudor-revival-high-school-building-in-roseland-chicago.jpg?s=1024x1024&w=is&k=20&c=xc6-O3vEv4MhVAyFdo0dDNxYdNn1ROagNh4l6Ljscq8=',
          imageAlt: 'Model wearing minimalist watch with black wristband and white watch face.',
        },
        {
          name: 'Spears Tower',
          href: '#',
          imageSrc: 'https://images.unsplash.com/photo-1540996699109-8fc0a0206f12?q=80&w=2454&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      <div className="relative bg-gray-900">
        ...
        <header className="relative z-10">
          <nav aria-label="Top">
            ...
            <div className="bg-rose-950 bg-opacity-80 backdrop-blur-md backdrop-filter">
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          <h1 className="text-5xl font-bold tracking-tight text-white lg:text-7xl">Cornerstone</h1>
          <h1 className="text-4xl font-bold tracking-tight text-white lg:text-6xl">Engineering & Surveying</h1>
